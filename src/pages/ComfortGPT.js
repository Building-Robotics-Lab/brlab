            ...
            <Container>
                <div className="third_section">
                    <div className="guidelines_text">
                        ...
                        <p>
                            ComfortGPT employs generative pre-trained models built on the data from thousands of ECOBEE thermostat users, to directly predict temperature setpoints while minimizing the reliance on occupant interactions. See CHEN Kai's publication <Link to="/publication/comfortgpt:_a"><b>here</b></Link> for a more in-depth description and analysis of the data behind this tool.
                        </p>
                        <h3>Guidelines</h3>
                        <p>
