                ...
                <div className="whole_theme">
                    <div className='theme_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/individual_profile/Kai">CHEN Kai</Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
                            <p>Chen, K., Xu, Q., Leow, B. and Ghahramani, A., 2022. <Link to="/individual_publication/personal_thermal" target="_blank"><b>Personal thermal comfort models based on physiological measurements-A design of experiments based review</b></Link>. <i>Building and Environment</i>, <i>228</i>, 109919.</p>
                        ...
                        <p><Link to="/ComfortGPT" target="_blank">ComfortGPT</Link></p>
                    </div>
                    <div className='theme_section' id='theme1_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/individual_profile/Riccardo">Riccardo Talami</Link>, supported by <Link to="/individual_profile/Ilyas">Ilyas Dawoodjee</Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
                            <p>Talami, R., Dawoodjee, I. and Ghahramani, A., 2023. <Link to="/individual_publication/demystifying_energy" target="_blank"><b>Demystifying energy savings from dynamic temperature setpoints under weather and occupancy variability</b></Link>. <i>Energy and Built Environment</i>.</p>
                        ...
                        <p><Link to="/otst" target="_blank">Optimal Temperature Setpoint Tool</Link></p>
                    </div>
                </div>
            </Container>
                ...
                <div className="whole_theme">
                    <div className='theme_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/individual_profile/Iqbal">Iqbal Shah</Link>, supported by <Link to="/individual_profile/Ilyas">Ilyas Dawoodjee</Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
                    ...
                    <div className='theme_section' id='theme2_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/individual_profile/Ilyas">Ilyas Dawoodjee</Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
                            ...
                            <p>Visit <Link to="https://github.com/blank-ed/remote_PPG" target="_blank"><b>GitHub - rPPG</b></Link> to find the actual implementations of the state-of-the-art rPPG algorithms.</p>
                        </div>
                    </div>
                    <div className='theme_section' id='theme2_section'>
                        <div className="theme_details">
                ...
                <div className="whole_theme">
                    <div className='theme_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/individual_profile/Iqbal">Iqbal Shah</Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
                            <p>Shah, I., Soh, B., Lim, C., Lau, S. K., and Ghahramani, A., 2023. <Link to="/individual_publication/thermal_transfer" target="_blank"><b>Thermal transfer and temperature reductions from shading systems on opaque facades: Quantifying the impacts of influential factors</b></Link>. <i>Energy and Buildings</i>, <i>278</i>, 112604.</p>
                    ...
                    <div className='theme_section' id='theme3_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/individual_profile/Kelly">Kelly Loh</Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
                ...
                <div className="whole_theme">
                    <div className='theme_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/individual_profile/Connor">Connor Aucremanne</Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
