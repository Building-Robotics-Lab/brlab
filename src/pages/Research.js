                ...
                <div className="whole_theme">
                    <div className='theme_section'>
                        <div className="theme_details">
                            ...
                            <p>This project is led by <Link to="/profile/Rezky"><b>Rezky Nanda</b></Link> and supported by <Link to="/profile/Maxime"><b>Maxime Caillat</b></Link>; previously led by Connor Aucremanne and supported by <Link to="/profile/Pierre"><b>Pierre-Louis David</b></Link>.</p>
                        </div>
                        <h4 className="keyObjs"><b>Key Objectives</b></h4>
                        <div className="theme_deliverables">
