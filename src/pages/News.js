...
function News() {
    ...
    const newsData = [
        ...
        },
        {
            ...
            content: (
                <>
                    The Building Robotics Lab is happy to have Pierre-Louis joining us as a visiting MSc student from ETH Zürich studying Mechanical Engineering and Computer Science. His research revolves around Machine Learning, Optimisation, Computer Vision, and Energy. Check out his full profile <Link to="/individual_profile/Pierre" >here</Link> to get to know him more!
                </>
            ),
        },
        {
        ...
        },
        {
            ...
            content: (
                <>
                    <Link to="/individual_profile/Riccardo">Riccardo</Link>, <Link to="/individual_profile/Ilyas" >Ilyas</Link>, and <Link to="/team#prof_profile">Asst Prof Ghahramani</Link> have published their paper: <Link to="/individual_publication/demystifying_energy" target="_blank"><b>Demystifying energy savings from dynamic temperature setpoints under weather and occupancy variability</b></Link>. They found that both fixed and dynamic setpoints ensure 2-4% energy reduction due to lower heat generated by occupants at lower occupancy rates. However, at outdoor temperatures ranging from 5°C to 32°C, where occupant heat loads can shift the building between heating, free-running, and cooling modes, dynamic setpoints can achieve additional 2-10% energy savings compared to fixed setpoints. Congratulations everyone!
                </>
            ),
        },
        {
        ...
        },
        {
            ...
            content: (
                <>
                    <Link to="/individual_profile/Kai" >Kai</Link>, <Link to="/team#prof_profile" >Asst Prof Ghahramani</Link>, and additional authors have published their paper: <Link to="/individual_publication/personal_thermal" target="_blank"><b>Personal thermal comfort models based on physiological measurements -- A design of experiments based review</b></Link>. This study aims to provide a systematic, comprehensive, and DOE-framework-based review of the physiological sensing methods to predict personal thermal comfort. This is also Kai\'s inaugural first-author article! Chapeau!
                </>
            ),
        },
        {
